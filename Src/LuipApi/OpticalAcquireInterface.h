...
/**
 * @brief 控制氙灯。
 * @param code Uint8，0为关闭，1为打开, 2为快速闪烁。
 *  - @ref DSCP_OK  操作成功；
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OAI_CTRL_XONEN                                                (DSCP_OAI_CBASE + 0x14)
/**
 * @brief 获取信号采集模块工作模式
 * @return mode Uint8，工作模式 0 = ONLY_AD7791, 1 = ONLY_ADS1146, 2 = BOTH_AD7791_ADS1146。
 */
#define DSCP_CMD_OAI_GET_ADC_WORK_MODE                                       (DSCP_OAI_CBASE + 0x15)

/**
 * @brief 设置信号采集模块工作模式
 * @param mode Uint8，工作模式 0 = ONLY_AD7791, 1 = ONLY_ADS1146, 2 = BOTH_AD7791_ADS1146。
 * @return 状态回应，Uint16，支持的状态有：
 *  - @ref DSCP_OK  操作成功；
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OAI_SET_ADC_WORK_MODE                                       (DSCP_OAI_CBASE + 0x16)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OAI_SET_CHECK_LEAKING_PERIOD                                       (DSCP_OAI_CBASE + 0x17)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OAI_SET_STATIC_MULTIPLE                                       		(DSCP_OAI_CBASE + 0x18)
